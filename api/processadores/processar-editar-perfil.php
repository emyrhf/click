    ...
    if (($_SERVER["REQUEST_METHOD"]=="POST")){
        ...
        if (isset($_FILES['updateProfilePic'])) {
            ...
            if ($erro_icon === 0) {
                ...
                $enviar_icon = '/api/public/imgs/'.$nome_unico_icon;
        ...
        if (isset($_FILES['updateHeader'])) {
            ...
            if ($erro_header === 0) {
                ...
                $enviar_header = '/api/public/imgs/'.$nome_unico_header;
        ...
        header("location: /click/api/visao/perfil.php?usuario=". $updateUsername);
